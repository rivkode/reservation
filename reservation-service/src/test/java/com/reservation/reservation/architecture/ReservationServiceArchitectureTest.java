package com.reservation.reservation.architecture;
...
@AnalyzeClasses(
    packages = "com.reservation.reservation",
    importOptions = ImportOption.DoNotIncludeTests.class
)
class ReservationServiceArchitectureTest {

    private static final String BASE = "com.reservation.reservation";

    @ArchTest
    static final ArchRule noCrossServiceImports = ArchitectureRules.noCrossServiceImports("reservation");
